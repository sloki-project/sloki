...
console.log(`sloki-cli dinary://localhost:${config.TCP_BINARY_PORT}`);
console.log(`sloki-cli dinarys://localhost:${config.TLS_BINARY_PORT}`);
console.log('');
console.log('Notes:');
console.log(' * tcp protocol is an alias for dinary protocol');
console.log(' * tls protocol is an alias for dinarys protocol');
